...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7ad8fca6ddf0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_asyncio', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7ad8fca6ddf0>, origin='/usr/lib/python3.12/lib-dynload/_asyncio.cpython-312-x86_64-linux-gnu.so')"

...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7ad8fd2bb3e0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_lzma', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7ad8fd2bb3e0>, origin='/usr/lib/python3.12/lib-dynload/_lzma.cpython-312-x86_64-linux-gnu.so')"

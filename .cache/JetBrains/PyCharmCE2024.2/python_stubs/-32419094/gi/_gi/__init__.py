# encoding: utf-8
# module gi._gi
# from /usr/lib/python3/dist-packages/gi/_gi.cpython-312-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
TYPE_GSTRING = None # (!) real value is '<GType GString (23406320)>'

TYPE_INVALID = None # (!) real value is '<GType invalid (0)>'

_API = None # (!) real value is '<capsule object "gi._API" at 0x73dd9a0246c0>'

_PyGObject_API = None # (!) real value is '<capsule object "gobject._PyGObject_API" at 0x73dd9a0240f0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x73dd9a1ead50>'

__spec__ = None # (!) real value is "ModuleSpec(name='gi._gi', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x73dd9a1ead50>, origin='/usr/lib/python3/dist-packages/gi/_gi.cpython-312-x86_64-linux-gnu.so')"

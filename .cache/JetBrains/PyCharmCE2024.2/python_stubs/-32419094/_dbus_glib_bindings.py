...
# from /usr/lib/python3/dist-packages/_dbus_glib_bindings.cpython-312-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x73dd9a19ae10>'

__spec__ = None # (!) real value is "ModuleSpec(name='_dbus_glib_bindings', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x73dd9a19ae10>, origin='/usr/lib/python3/dist-packages/_dbus_glib_bindings.cpython-312-x86_64-linux-gnu.so')"

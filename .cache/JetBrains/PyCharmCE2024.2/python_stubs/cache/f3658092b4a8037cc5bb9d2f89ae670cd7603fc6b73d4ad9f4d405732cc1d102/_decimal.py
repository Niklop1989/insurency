...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x79faa7f6c710>'

__spec__ = None # (!) real value is "ModuleSpec(name='_decimal', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x79faa7f6c710>, origin='/usr/lib/python3.12/lib-dynload/_decimal.cpython-312-x86_64-linux-gnu.so')"

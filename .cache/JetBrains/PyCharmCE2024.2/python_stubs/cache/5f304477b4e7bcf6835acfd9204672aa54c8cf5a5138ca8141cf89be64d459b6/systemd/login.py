...
# from /usr/lib/python3/dist-packages/systemd/login.cpython-312-x86_64-linux-gnu.so
# by generator 1.147
...
__spec__ = None # (!) real value is "ModuleSpec(name='systemd.login', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x73dd9a19a930>, origin='/usr/lib/python3/dist-packages/systemd/login.cpython-312-x86_64-linux-gnu.so')"

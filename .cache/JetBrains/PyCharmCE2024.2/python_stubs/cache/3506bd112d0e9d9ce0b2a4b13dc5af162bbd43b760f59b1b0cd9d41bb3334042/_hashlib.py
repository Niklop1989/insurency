...
openssl_md_meth_names = None # (!) real value is "frozenset({'sha512', 'sha3_256', 'sha384', 'sha512_224', 'md5-sha1', 'shake_256', 'sha512_256', 'sha3_224', 'sm3', 'sha256', 'sha3_512', 'shake_128', 'sha1', 'blake2s', 'ripemd160', 'sha224', 'blake2b', 'sha3_384', 'md5'})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x79faa870eba0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x79faa870eba0>, origin='/usr/lib/python3.12/lib-dynload/_hashlib.cpython-312-x86_64-linux-gnu.so')"

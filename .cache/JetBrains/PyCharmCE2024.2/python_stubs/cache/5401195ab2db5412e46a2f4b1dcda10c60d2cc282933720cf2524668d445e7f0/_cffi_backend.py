...
# from /usr/lib/python3/dist-packages/_cffi_backend.cpython-312-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
_C_API = None # (!) real value is '<capsule object "cffi" at 0x73dd9a19b3c0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x73dd9a19af00>'

__spec__ = None # (!) real value is "ModuleSpec(name='_cffi_backend', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x73dd9a19af00>, origin='/usr/lib/python3/dist-packages/_cffi_backend.cpython-312-x86_64-linux-gnu.so')"

...
# from /usr/lib/python3/dist-packages/_dbus_bindings.cpython-312-x86_64-linux-gnu.so
# by generator 1.147
"""
...
NULL_MAIN_LOOP = None # (!) real value is '<dbus.mainloop.NativeMainLoop object at 0x73dd9a19ad90>'

_C_API = None # (!) real value is '<capsule object "_dbus_bindings._C_API" at 0x73dd9a19a970>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x73dd9a19af00>'

__spec__ = None # (!) real value is "ModuleSpec(name='_dbus_bindings', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x73dd9a19af00>, origin='/usr/lib/python3/dist-packages/_dbus_bindings.cpython-312-x86_64-linux-gnu.so')"

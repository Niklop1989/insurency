...
config = None # (!) real value is '<apt_pkg.Configuration object at 0x73dd9a19b8a0>'
...
_C_API = None # (!) real value is '<capsule object "apt_pkg._C_API" at 0x73dd9a1d4810>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x73dd9a19ad50>'

__spec__ = None # (!) real value is "ModuleSpec(name='apt_pkg', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x73dd9a19ad50>, origin='/usr/lib/python3/dist-packages/apt_pkg.cpython-312-x86_64-linux-gnu.so')"

...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7ad8fd301be0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_json', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7ad8fd301be0>, origin='/usr/lib/python3.12/lib-dynload/_json.cpython-312-x86_64-linux-gnu.so')"

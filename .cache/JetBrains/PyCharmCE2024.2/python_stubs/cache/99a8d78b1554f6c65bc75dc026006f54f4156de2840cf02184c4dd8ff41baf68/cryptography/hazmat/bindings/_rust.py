...
import pkcs7 as pkcs7 # <module 'pkcs7'>
import exceptions as exceptions # <module 'exceptions'>
import x509 as x509 # <module 'x509'>
import ocsp as ocsp # <module 'ocsp'>
import _openssl as _openssl # <module '_openssl'>
import openssl as openssl # <module 'openssl'>
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x73dd9a19bce0>'

__spec__ = None # (!) real value is "ModuleSpec(name='cryptography.hazmat.bindings._rust', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x73dd9a19bce0>, origin='/usr/lib/python3/dist-packages/cryptography/hazmat/bindings/_rust.abi3.so')"

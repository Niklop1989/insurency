...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x79faa7f6d340>'

__spec__ = None # (!) real value is "ModuleSpec(name='_zoneinfo', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x79faa7f6d340>, origin='/usr/lib/python3.12/lib-dynload/_zoneinfo.cpython-312-x86_64-linux-gnu.so')"

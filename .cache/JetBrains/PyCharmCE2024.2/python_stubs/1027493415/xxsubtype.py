...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x79faa7f6de50>'

__spec__ = None # (!) real value is "ModuleSpec(name='xxsubtype', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x79faa7f6de50>, origin='/usr/lib/python3.12/lib-dynload/xxsubtype.cpython-312-x86_64-linux-gnu.so')"
